...
<body>
  <div class="header">
    ...
    <div class="sub">The Living Room Conversation</div>
  </div>
  ...
  <div class="body">
    ...
    <table class="details">
      <tr>
        ...
        <td class="value">Saturday, 11th July 2026</td>
      </tr>
      <tr>
        <td class="label">Time</td>
        <td class="value">1:00 PM</td>
      </tr>
      <tr>
        <td class="label">Venue</td>
        <td class="value">The Nest Gardens, Guzape, Abuja</td>
      </tr>
    </table>
  ...
  <div class="footer">
    Present this ticket (printed or on your phone) at the entrance for check-in.<br>
